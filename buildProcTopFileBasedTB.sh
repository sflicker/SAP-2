...
ghdl -a --std=08 -fsynopsys -v IO_Interface.vhd
...
ghdl -r --std=08 -fsynopsys -v proc_top_filebased_tb -gfile_name="loop_test_with_output.txt" --stop-time=100000ns --vcd=loop_test_with_output.vcd
