...
set_property PACKAGE_PIN W7 [get_ports {o_cathodes[6]}]
set_property PACKAGE_PIN W6 [get_ports {o_cathodes[5]}]
set_property PACKAGE_PIN U8 [get_ports {o_cathodes[4]}]
set_property PACKAGE_PIN V8 [get_ports {o_cathodes[3]}]
set_property PACKAGE_PIN U5 [get_ports {o_cathodes[2]}]
set_property PACKAGE_PIN V5 [get_ports {o_cathodes[1]}]
set_property PACKAGE_PIN U7 [get_ports {o_cathodes[0]}]
